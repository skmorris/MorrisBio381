...
\usepackage{listings} % allows for more seamless r-code embedding
\usepackage{varwidth} % to allow me to have 2 figures with captions side by side  
...
\usetheme{default}
% THEMES: default, AnnArbor, Antibes, Bergen, Berkeley, Berlin, Boadilla, boxes, CambridgeUS, Copenhagen, Darmstadt, default, Dresden, Frankfurt, Goettingen, Hannover, Ilmenau, JuanLesPins, Luebeck, Madrid, Malmoe, Marburg, Montpellier, PaloAlto, Pittsburgh, Rochester, Singapore, Szeged, Warsaw
...
% TITLE PAGE DATA--------------------------
\title[My presentation]{Sarah's presentation} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Sarah K. Morris} % Your name
...
\medskip
\textit{skmorris@uvm.edu} % Your email address
}
...
% SLIDE (FIGURE)-----------------------------
\begin{frame}
\frametitle{Me, in my native habitat}
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
\begin{figure}
\includegraphics[width=1.0\linewidth]{IMG_3681.jpg}
% use this format for absolute sizing
%\includegraphics[width=50cm, height=12.93cm]{UVMlogo.jpg}
\end{figure}
\end{frame}

% SLIDE (FIGURE)-----------------------------
\begin{frame}
\frametitle{Colombia \& The Choc\'o}
  \begin{varwidth}{\textwidth}
    \begin{figure}
        \includegraphics[height=0.45\textheight, frame]{OP_map.jpg}
        \caption{The Choc\'o}
    \end{figure}
  \end{varwidth}
  \hfill
  \begin{varwidth}{\textwidth}
      \begin{figure}
        \includegraphics[height=0.45\textheight, frame]{COL_collections.jpg}
        \caption{Colombia plant collections heatmap}
      \end{figure}
    \end{varwidth}
\end{frame}
